...
/**
 * Repository that provides insert, update, delete, and retrieve of [Tarefa] from a given data source.
 */
interface TarefasRepository {
    fun getAllTarefasStream(): Flow<List<Tarefa>>

    fun getTarefaStream(id: Int): Flow<Tarefa>
